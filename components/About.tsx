...
export default function About({ }: Props) {
    return (
        <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row tracking-[15px] max-w-5xl px-10 justify-evenly mx-auto items-center'>
            ...
            <div className='-mt-20 space-y-10 px-0 md:px-10'>
                <h4 className='text-xl md:text-2xl mt-14 font-semibold tracking-normal md:mt-32 text-gray-400'>
